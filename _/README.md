...
> | Tue, April 7, 2026 | 14 | 20 | Reviewed the triangle inequality, proved the parallelogram equality, started **§ 6B. Orthogonal Bases**; introduced the notion (**Definition 6.23**), looked at an example (**Example 6.24**), proved a proposition about norm of orthonormal linear combinations (**Proposition 6.25), stated a corollary saying on orthonormal list is linearly independent (**Corollary 6.26**), introduced orthonormal bases (**Definition 6.27**), looked at a few examples (**Example 6.29**), showed how a vector can be written as a linear combination of an orthonormal basis (**Proposition 6.30**), explained the Gram Schmidt procedure (**Proposition 6.31**), and concluded by showing how an orthonormal list can be extended to an orthonormal basis (**Corollary 6.35**), using Gram-Schmidt. <br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub>
\* 
