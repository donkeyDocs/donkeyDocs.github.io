...
> | Fri, Mar 6, 2026 | 10 | 15 | (I joined the wrong Teams link so there's no Teams recording but fortunately, I did record the iPad screen locally) <br/>**Review of Chapter 3** (to help everyone get caught up, after the mid-sem exam) from the beginning, until **Theorem 12**. Covered all the definitions and important results (without proofs). <br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub>| 
