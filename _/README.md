...
> | Thu, Jan 9, 2025 | 2 | 3 | <sub> </sub> Commutators, uncertainty principle, mixed states, purifications, Uhlman's theorem, Schmidt decomposition <br/> <sub> [[notes]](../QuantumAspectsOfCryptography/WeeklyLN/W2_L2.pdf) </sub> <br/> <sub>[[video]](https://youtu.be/LClPJ7phDAg) </sub>
...
> | Thu, Apr 3, 2025 | 14 | 22 | Relative to a quantum oracle, **BQP = QMA and yet, Pseudorandom unitaries exist.** Introduction and preliminaries to establish this result. <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
> | Mon, Apr 7, 2025 | 15 | 23 | Relative to a quantum oracle, **BQP = QMA and yet, Pseudorandom unitaries exist.** Proving the first part of this result. <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
> | Thu, Apr 10, 2025 | 15 | 24 | Relative to a quantum oracle, **BQP = QMA and yet, Pseudorandom unitaries exist.** Completed the proof of the first part of this result (one step appears to have some gap). <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive (soon) [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube (soon) [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
> | Mon, Apr 14, 2025 | 16 | 25 | **Quantum Fully Homomorphic Encryption** explained from the Appendix of KLVY'23. <br/> (cont.) **BQP = QMA and yet, Pseudorandom unitaries exist.** Barely started the second part of this result (motivated how the proof goes through Grover's search). <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive (soon) [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube (soon) [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
> | Thu, Apr 17, 2025 | 16 | - | Friday's schedule was followed, we lost a class. |
> | Mon, Apr 21, 2025 | 17 | 26 | **Self-testing.** Gave the construction for CHSH explicitly. <br/> (cont.) **BQP = QMA and yet, Pseudorandom unitaries exist.** Completed the proof of the second part of this result, but in the case without advice (formalised how it reduces to Grover's search). <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive (soon) [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube (soon) [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
> | Thu, Apr 24, 2025 | 17 | 27 | **Verification.** Looked at Grilo's construction for classical verification of quantum computation, in one round, with two non-communicating provers.  <br/> Notes <sup><sub> (soon) [[folder]](https://github.com/donkeyDocs/donkeyDocs.github.io/tree/master/QuantumAspectsOfCryptography/WeeklyLN) </sub></sup> <br/> Video <sup><sub>OneDrive (soon) [[folder]](https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saikumar_ravu_iiit_ac_in/EkR_XvZnKbBDg_t_V_4QeeUB2bpem3LrHdXQ06jvz_1u-w?e=jWRDXF)</sup></sub> <sup><sub>YouTube (soon) [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8WzxHvqc2NBKbzrjbKHzeEW) </sub></sup> |
