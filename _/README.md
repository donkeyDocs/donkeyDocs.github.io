...
> | Fri, Jan 9, 2026 | 2 | 3 | Housekeeping + continued with how to solve using row-reduced echelon, Theorem 6 (condition for homogeneous system to have non-zero solutions), Theorem 7 (for square matrices, row-equivalent to identitiy $\iff$ all zeros is the only solution), augmented matrix, solving non-homogenous systems and criteria for solutions to exist, remark about solution in a subfield, given a solution in a field, §1.5 Matrix Multiplication—definitions, examples + Theorem 8 (associativity, stated, proof HW) + elementary matrices + Theorem 9 (elementary row operations as matrices) <br/> <sub> Video [[OneDrive]](https://iiitaphyd-my.sharepoint.com/:v:/g/personal/atul_arora_iiit_ac_in/IQAL9V9ci3WqQKS4vVWunXh0AQS9BUU1m62LDusV-lIX44Y?e=B9nlMr&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D) </sub> <br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub> </br> <sub> Feedback [[folder]](../LinearAlgebra_WinterSpring_2026/Feedback)  </sub>|
...
> | Tue, and Fri, Feb  2026  | 5 | 6 (displaced holiday) and 7 (quiz) | (pre-recorded) Using the technical lemma (in the previous lecture), established Theorem 5 (if $W$ is a subspace of a finite space $V$, then any linearly independent set in $W$ is (finite and) part of a basis for $W$, proved Corollary 1 ($\dim W < \dim V$), Corollary 2 and 3 (If the rows of a square matrix $A$ form linearly independent vectors, then $A$ is invertible). <br/>  <sub> YouTube [[playlist]](https://www.youtube.com/plylist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub> | 
