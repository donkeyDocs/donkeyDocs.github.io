...
> | Tue, Mar 17, 2026 | 12 | 18 | Redid the proof of **Theorem 5.27** (Every operator (over $C$) has an upper-triangular matrix), stated and proved **Proposition 5.30** (given upper-triangular, invertible iff diagonal entries nonzero), **Proposition 5.32** (given upper-triangular, diagonals are eigenvalues), explained **Example 5.33**. Started **§5C**, defined diagonal matrices, defined eigenspaces $E(\lambda,T)$, explained **Example 5.37**, stated and proved **Proposition 5.38** (says sum of eigenspaces is a direct sum), defined ''diagonalisable'', looked at **Example 5.40** and stopped there.
<br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub> |
