...
> | Tue, April 11, 2026 | 15 | 22 |  Recalled the definition of an upper triangular matrices, stated **Lemma 6.37** (Upper-triangular matrices with respect to orthonormal basis) and gave some intuition for the proof (proof is asked in Assignment 10), stated and proved **Theorem 6.38** (Schur's Theorem) using the lemma and previous results; introduced Linear Functionals (**Definition 6.39), looked at **Example 6.40** and left **Example 6.41** (covered in Assignment 10),  <br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub>
\* 
