...
> | May 3, 2023 |Chapter 3 |  <sub> <p> [[video—part 1]](https://youtu.be/a0J_JWyn_Ww)  </p> <p>[[video—part 2]](https://youtu.be/FIkACz7ihRc) </p> <p> video—part 3 [[A]](https://youtu.be/khdR_los8J0) [[B]](https://youtu.be/v9mPodhoz40) (3B is covered again below) </p> <p> video—part 4 [[A]](https://youtu.be/2cxb-cDt0Xc) [[B]](https://youtu.be/lbgdMtAy3eM) (Symantic Security and Pseudorandomness) </p> <p> video—part [4](https://youtu.be/MUjyMunS5Jg) (Stream Ciphers, multiple encryptions, CPA security, pseudorandom functions)</p> <p> [scheduled: §Proof of Theorem 3.26; CPA secure scheme using pseudorandom functions] </p></sub>  |  
