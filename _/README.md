...
> | Tue, April 14, 2026 | 15 | 23 |  Quickly reviewed the statement of **Theorem 7.10** (matrix of $T^*$). Started with _self-adjoint operators_ by stating **Definition 7.11**, looked at **Example 7.12**, explained how adjoint plays a role similar to complex conjugation, stated and proved **Theorem 7.13** (Every eigenvalue of a self-adjoint operator is real); stated and proved **Theorem 7.14** (over the complex field, $\langle Tv, v \rangle = 0 $ for all $v$ means $T=0$), discussed how this fails when the field is real; stated and proved **Theorem 7.15** ($T$ is self-adjoint iff $\langle Tv,v \rangle =0$ for all $v$; over a complex field); stated and proved **Theorem 7.14** (over complex, if )  <br/> <sub> YouTube [[playlist]](https://www.youtube.com/playlist?list=PLXdfACMlsN8Wxqu-DgD6gF1WbaoTGL8_u) </sub>
\* 
